...
# 窗口切换触发 Prompt
WINDOW_CHANGE_PROMPT_TEMPLATE = """可以评论窗口、表达想法、或者分享心情等内容。
口语化：严禁使用书面语、翻译腔或机器生成的格式化列表。必须使用自然且符合人设的简短口语，不带冗长的解释。"""
...
{{
  ...
  "intensity": 0.0-1.0,
  "reason": "判断理由（30字以内，句式和话题要与最近对话明显不同，可以从以下选择：陈述句/感叹句/吐槽句/撒娇句/疑问句开头）",
  "bubble_text": "你想说的话（20字以内，句式和话题要与最近对话明显不同，可以从以下选择：陈述句/感叹句/吐槽句/撒娇句/疑问句开头）"
}}"""
